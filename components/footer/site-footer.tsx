      ...
      <div className="mx-auto w-[min(1200px,92vw)]">
        ...
        <div className="grid gap-10 py-10 md:grid-cols-3">
          <div>
            ...
            <div className="flex flex-col items-start gap-3 text-sm text-ink/60"><a href="#collection">The Collection</a><a href="#soap-finder">Soap Finder</a><a href="#ritual">The Ritual</a><a href="#contact">Contact</a></div>
          </div>
          <div>
